...
export default function HeroSection() {
  return (
    <section className="relative w-full min-h-310 flex flex-col items-center text-center px-4 sm:px-6 lg:px-8 py-20 bg-[#FFF8F0] overflow-hidden">
      <div className="relative w-full [@media(min-width:1400px)]:w-365 min-h-310 flex flex-col items-center text-center px-4 sm:px-6 lg:px-8 py-20 bg-[#FFF8F0] overflow-hidden">
        {/* Main Content */}
